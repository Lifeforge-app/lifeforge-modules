...
const subjects = [
  {
    ...
    subjects: [
      ...
      {
        entity: "LP",
        subject: "Precision approach path indicator (PAPI) (specify runway)",
      },
  ...
  },
  {
    ...
    subjects: [
      ...
      {
        entity: "MM",
        subject: "Daylight markings (specify threshold, centre line, etc.)",
      },
  ...
  },
  {
    ...
    subjects: [
      ...
      {
        entity: "CB",
        subject: "Automatic dependent surveillance — broadcast (details)",
      },
      {
        entity: "CC",
  ...
  },
  {
    ...
    subjects: [
      {
        entity: "GA",
        subject: "GNSS airfield-specific operations (specify operation) ",
        type: "I",
      },
      {
        entity: "GW",
  ...
  },
  {
    ...
    subjects: [
      ...
      {
        entity: "NX",
        subject: "Direction finding station (specify type and frequency)",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    subjects: [
      ...
      {
        entity: "PI",
        subject: "Instrument approach procedure (specify type and runway)",
      },
...
const modifiers = [
  {
    ...
    list: [
      ...
      {
        status: "AG",
        modifier: "Operating but ground checked only, awaiting flight check",
  ...
  if (text.length >= 15) {
    ...
    for (let index = 0; index < text.length - 15; index++) {
      if (
        ...
        if (
          !isNaN(+text.substring(index, index + 6).replace(/[^\d]/g, "0")) &&
          !isNaN(+text.substring(index + 7, index + 14).replace(/[^\d]/g, "0"))
        ) {
    ...
    for (let index = 0; index < text.length - 16; index++) {
      if (
        ...
        if (
          !isNaN(+text.substring(index, index + 6).replace(/[^\d]/g, "0")) &&
          !isNaN(+text.substring(index + 7, index + 15).replace(/[^\d]/g, "0"))
        ) {
    ...
    for (let i = 0; i < text.length - 22; i++) {
      if (
        ...
        if (
          ...
          !isNaN(+text.substring(i + 11, i + 18).replace(/[^\d.]/g, "0")) &&
  ...
  for (const c of purpose) {
    switch (c) {
      ...
      case "B":
        res.push({
          code: c,
          description: "For inclusion in Preflight Infomation Bulletins",
        });
        break;
      case "M":
